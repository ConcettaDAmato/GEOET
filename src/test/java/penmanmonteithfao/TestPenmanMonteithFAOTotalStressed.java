...
public class TestPenmanMonteithFAOTotalStressed{
    ...
    public void Test() throws Exception {
        ...
        String endDate	= "2014-12-16 00:00";
        ...
        String inPathToSoilMosture 			="resources/Input/dataET_point/1/SoilMoistureSen.csv";
        
        String pathToEvapotranspirationFAO	="resources/Output/ETPotentialFAOCavone_"+lab1+".csv";
        String pathToLatentHeatFAO			="resources/Output/FluxETPotentialFAOCavone_"+lab1+".csv";
		...
		PMstressfactor.waterFieldCapacity = 0.35; 
		PMstressfactor.depth = 1.50;
		PMstressfactor.depletionFraction = 0.45;
